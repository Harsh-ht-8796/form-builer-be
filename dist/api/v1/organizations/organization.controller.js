...
let OrganizationController = class OrganizationController {
    ...
    create(organizationData, user) {
        return __awaiter(this, void 0, void 0, function* () {
            var _a;
            const createdBy = (_a = user === null || user === void 0 ? void 0 : user._id) === null || _a === void 0 ? void 0 : _a.toString();
            const organization = yield this.organizationService.create(Object.assign({}, organizationData));
            return organization;
        });
    }
    get(id, next) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                const organization = yield this.organizationService.getById(id);
                if (!organization) {
    ...
    update(id, organizationData) {
        return __awaiter(this, void 0, void 0, function* () {
            const organization = yield this.organizationService.update(id, organizationData);
            if (!organization) {
                throw new Error('Organization not found');
            }
            return organization;
    ...
    delete(id) {
        return __awaiter(this, void 0, void 0, function* () {
            const organization = yield this.organizationService.delete(id);
            if (!organization) {
                throw new Error('Organization not found');
            }
            return organization;
    ...
    getAll() {
        return __awaiter(this, void 0, void 0, function* () {
            const organizations = yield this.organizationService.findAll();
...
__decorate([
    ...
    (0, routing_controllers_1.UseBefore)((0, validation_middleware_1.default)(organization_dto_1.OrganizationDto, 'body')),
